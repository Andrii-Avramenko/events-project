...
<div class="modal-main"><img src="${mainEventImg.url}" alt='' class='modal-artist-main' /><div class='modal-info'>
  <section>
  ...
  <a href="${event._embedded.attractions[0].url}" target="_blank"><button type="button">MORE FROM THIS AUTHOR</button></a>
</div>
</div>`;
